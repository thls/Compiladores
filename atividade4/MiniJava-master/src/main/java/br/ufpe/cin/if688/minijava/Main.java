...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        CharStream charStream = CharStreams.fromFileName("/home/thls/Documents/atividade4/MiniJava-master (copy)/src/main" +
                "/java/br/ufpe/cin/if688/minijava/in/BubbleSort.java");
